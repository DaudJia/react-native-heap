  ...
  private static Map<String, String> convertToStringMap(ReadableMap readableMap) {
    ...
    while (mapIterator.hasNextKey()) {
      ...
      case Map:
        ...
        Log.w("RNHeap","Property objects must be flattened before being sent across the JS bridge. If you get this warning please inspect for non-flattenable objects being sent to Heap");
      }
    }
    return stringMap;
  }
